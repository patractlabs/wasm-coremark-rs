(module
  ...
  (import "env" "clock_ms" (func (;0;) (type 5)))
  ...
  (func (;4;) (type 9) (result f32)
    (local i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 i32 f32 f64)
    global.get 0
    i32.const 80
    i32.sub
    local.tee 0
  ...
  (func (;6;) (type 4) (param i32 i32 i32 i32)
    ...
    i32.and
    i32.store offset=12)
  (func (;7;) (type 8) (param i32 i32 i32 i32 i32 i32) (result i32)
    (local i32 i32 i32 i32)
    global.get 0
    i32.const 80
    i32.sub
